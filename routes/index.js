...
router.get('/', function (req, res) {
  res.render('index', { title: 'Television App', user: req.user });
});

router.get('/register', function (req, res) {
  res.render('register', { title: 'Television App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'Television App Login', user: req.user });
});
